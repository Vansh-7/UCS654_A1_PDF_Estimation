...
- Valid NO2 samples used after cleaning: 419509
...
For roll number **102483084**:
- $r \bmod 7 = 4 \Rightarrow a_r = 0.2$
...
| a_r | 0.2 |
| b_r | 1.5 |
| Estimated Mean (mu) | 25.816375 |
| Estimated Lambda (lambda) | 0.001461 |
| Estimated c | 0.021569 |
